...
int main()
{
	printf("%d\n", num_words("abc dfds sdfad eafa"));
	printf("%d\n", length_nthword("abc dfds sdfad eafa", 5));
	printf("%s\n", nth_word("abc dfds sdfad eafa", 5));
	char **a = ft_split_whitespaces("abc dfds sdfad eafa");
	int i = 0;
	while(i < num_words("abc dfds sdfad eafa"))
	{
			printf("%s\n",a[i]);
			i++;
	}
